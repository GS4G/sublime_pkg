...
def indent_vhdl(lines, initial=0, tab_size=4, use_spaces=True):
    ...
    rules_str = sublime.load_resource('Packages/NX/Syntax/beautify_rules.yaml')
...
class Port():
    ...
    def parse_str(self, port_str):
        ...
        if s:
            ...
            print('enyx_beauty: Could not parse port string.')
            self.success = False
...
class Generic():
    ...
    def parse_str(self, gen_str):
        ...
        if s:
            ...
            print('enyx_beauty: Could not parse generic string.')
            self.success = False
...
class Parameter():
    ...
    def parse_str(self, param_str):
        ...
        if s:
            ...
            print('enyx_beauty: Could not parse parameter string.')
            self.success = False
    ...
    def parse_generic_port(self):
        ...
        if port_search:
            ...
            if port_str is not None:
                ...
                print('enyx_beauty: No ports found.')
                port_str = ""
        else:
            print('enyx_beauty: No ports found.')
            port_str = ""
        ...
        if gen_search:
            ...
            if gen_str is not None:
                ...
                print('enyx_beauty: No generics found.')
                gen_str = ""
        else:
            print('enyx_beauty: No generics found.')
            gen_str = ""
...
class Subprogram():
    ...
    def parse_block(self):
        ...
        if start and stop:
            ...
            print('enyx_beauty: No subprogram parameters found.')
