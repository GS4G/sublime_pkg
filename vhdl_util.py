...
def get_vhdl_setting(cmd_obj, key):
    ...
    vhdl_settings = sublime.load_settings('enyx_beauty.sublime-settings')
...
def scan_instantiations(cmd_obj):
    ...
    for region in regions:
        ...
        if s:
            ...
            print('enyx_beauty: Could not match instantiation on line {}'.format(row+1))
    return instances
